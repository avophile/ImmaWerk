# ImmaWerk
Delta Team's Chatbot for Immigrant Workers and Others in Finland

### How do I collaborate on the ImmaWerk project?
...
You could call your ImmaWerk project directory something like this (use your own student number!):

```git
    C:\Users\s1900123\ImmaWerk
```
...
To create a local clone of the ImmaWerk project repository type:

```git
    git clone https://github.com/avophile/ImmaWerk.git
```
...
You should now see the same list of folders as before, with the new ImmaWerk folder added.

Move into the ImmaWerk folder by typing:
...
You might not be able to see it, and you don’t necessarily need to see it but there *is* a hidden .git folder in the ImmaWerk directory. This folder contains the git magic that makes everything work. 
...
```git
    ...
    From https://github.com/avophile/ImmaWerk
...
```git
    https://github.com/avophile/ImmaWerk
```
